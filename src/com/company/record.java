...
public class record {
    ...
    public static void add_winner_recode(Person person,Person loser)throws Exception{
        ...
        preparedStatement.setString(6,person.shoupais[0].toString()+"与"+person.shoupais[1].toString());
    ...
    public static void add_pinju_recode(Person person,Person loser)throws Exception{
        Connection connection=DButil.set_comment();
        String sql=("INSERT INTO record(user1_name,user1_id,winner_id,date,winner_name,winner_shoupai,loser_shoupai,user2_name,user2_id) VALUES(?,?,?,?,?,?,?,?,?)");
        PreparedStatement preparedStatement =connection.prepareStatement(sql.toString());
        preparedStatement.setString(1,person.getName());
